    ...
    <div id="home">
        ...
        <nav>
            ...
            <ul>
                ...
                <li><a href="b_activity.html">ACTIVITY</a></li>
                <li><a href="a_home.php#store">STORE</a></li>
                <li><a href="c_esport.html">ESPORT</a></li>
                <li><a href="e_contact-us.html">CONTACT US</a></li>
        ...
        <div id="content">
            ...
            <div class="subs-content">
                ...
                <div class="subs-content-box">
                    ...
                    <div class="input">
                        <form action="/uas_wp6/subs/kirim.php" method="POST">
            ...
            <div class="container">
                ...
                <div class="footer-content">
                    ...
                    <ul class="list">
                        ...
                        <li><a href="b_activity.html">Activity</a></li>
                        <li><a href="c_esport.html">Esports</a></li>
                        <li><a href="a_home.php#store">Store</a></li>
                    </ul>
                </div>
                <div class="footer-content">
                    <h3>FAQ & Policy</h3>
                    <ul class="list">
                        <li><a href="../1_html/policies.html#">All Terms & Policies</a></li>
                        <li><a href="../1_html/policies.html#privacy-policy">Privacy Policy</a></li>
                        <li><a href="../1_html/policies.html#comgd">Community Guidelines</a></li>
                        <li><a href="../1_html/policies.html#faq">FAQ</a></li>
                    </ul>
                </div>
